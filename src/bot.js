...
<head>
  ...
  <title>Darkboy — Multi Connexion</title>
  <style>
...
<div class="header">
  <div class="logo">🚀</div>
  <h1>Darkboy — Multi Connexion</h1>
  <div class="sub">by Odkbxss | Connecte plusieurs numéros WhatsApp</div>
</div>

<div class="add-card">
  <h2>➕ Connecter un numéro</h2>
  <div class="hint">Entre ton numéro complet au format international, SANS le +, SANS espaces ni zéro initial.<br>Exemple Burkina Faso : <b style="color:#00ff88">22662408620</b></div>
  <div class="input-row">
    <input type="tel" id="phoneInput" placeholder="22662408620" maxlength="15"/>
    <button class="btn-add" onclick="addSession()" id="btnAdd"1
    ...
    grid.innerHTML = sessions.map(function(s) {
      ...
      if (s.isConnected) {
        return '<div class="session-card connected">' + removeBtn +
          ...
          '<div style="color:#888;font-size:12px">Darkboy actif 🚀</div></div>';
